...
#[test]
fn tile_creation() {
    let tile = Tile::new(TilePos::new(0, 0), TileType::Sand, 1, TileFlags::TRAVERSABLE);
    assert_eq!(tile.coords, TilePos::new(0, 0));
...
#[test]
fn set_extra_data() {
    let mut tile = Tile::new(TilePos::new(1, 1), TileType::Wall, 2, TileFlags::BUILDABLE);
...
#[test]
fn flags() {
    let tile = Tile::new(TilePos::new(2, 2), TileType::Fluid(crate::FluidType::Magma), 3, TileFlags::TRAVERSABLE | TileFlags::LIQUID);
    assert!(tile.flags.contains(TileFlags::TRAVERSABLE));
...
#[test]
fn tile_type() {
    let empty_tile = Tile::new(TilePos::new(3, 3), TileType::Empty, 4, TileFlags::empty());
    let wall_tile = Tile::new(TilePos::new(4, 4), TileType::Wall, 5, TileFlags::TRAVERSABLE);
...
#[test]
fn tile_flags() {
    let tile = Tile::new(TilePos::new(5, 5), TileType::Floor, 6, TileFlags::DIGGABLE | TileFlags::BUILDABLE);
...
#[test]
fn custom_tile_type() {
    let custom_tile = Tile::new(TilePos::new(6, 6), TileType::Custom(7), 7, TileFlags::empty());
...
#[test]
fn tile_hp() {
    let tile = Tile::new(TilePos::new(7, 7), TileType::Wall, 8, TileFlags::empty());
